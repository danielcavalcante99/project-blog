...
public class UserRequestDTO  implements Serializable {
	...
	@NotBlank(groups = OnUpdate.class, message = "O campo 'userId' é obrigatório ser informado na atualização.")
	...
	@NotBlank(message = "O campo 'email' é obrigatório ser informado.")
