...
public class CommentRequestDTO implements Serializable{
	...
	@NotNull(groups = OnUpdate.class, message = "O campo 'commentId' é obrigatório ser informado na atualização.")
	private String commentId;

	@NotNull(groups = {OnCreate.class, OnUpdate.class}, message = "O campo 'postId' é obrigatório.")
	private String postId;
	
	@NotNull(groups = {OnCreate.class, OnUpdate.class}, message = "O campo 'userId' é obrigatório.")
